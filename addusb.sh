...
#
echo -e "Ahora te mostrare los 2 seriales me tienes que decir cual de los 2 quieres, ${turquoiseColour}$seriala${endColour}, ${yellowColour}$serialb${endColour}, ${redColour}Salir${endColour} [${turquoiseColour}1${endColour}/${yellowColour}2${endColour}/${redColour}3${endColour}]"
select yn in "$seriala" "$serialb" "Salir"; do
     case $yn in
